    ...
    useEffect(() => {
        if (destination) {
            setFormData({
                ...
                popularity_badge: destination.popularity_badge || "",
        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update destination details. Changes will be reflected immediately.
                    </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                value={formData.popularity_badge || "none"}
                                onValueChange={(value) =>
                                    setFormData((prev) => ({
                                        ...prev,
                                        popularity_badge: value === "none" ? "" : value
                                    }))
                                }
                            >
                                <SelectTrigger>
